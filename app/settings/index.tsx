...
export default function SettingsScreen() {
  ...
  const updateAccessibilitySetting = (key: keyof Settings['accessibility'], value: boolean) => {
    const newSettings = {
      ...settings,
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      ...
      <View style={styles.section}>
        ...
        <TouchableOpacity onPress={() => setShowLanguagePicker(!showLanguagePicker)}>
...
const styles = StyleSheet.create({
  ...
  languageList: { marginTop: -Spacing.xs, marginBottom: Spacing.sm },
  languageOption: {
    flexDirection: 'row',
    alignItems: 'center',
    justifyContent: 'space-between',
  ...
  languageOptionSelected: { backgroundColor: Colors.primaryMuted },
