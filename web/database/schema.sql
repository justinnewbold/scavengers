-- Scavengers Database Schema v2 for Vercel Postgres
...
INSERT INTO challenges (hunt_id, title, description, points, verification_type, hint, order_index) VALUES
  ...
  ('11111111-1111-1111-1111-111111111111', 'History Buff', 'When was the city founded? Find the plaque.', 20, 'text_answer', 'The plaque is near city hall', 4),
  ...
  ('22222222-2222-2222-2222-222222222222', 'Tree Identification', 'What type of tree has the numbered tag #42?', 15, 'text_answer', 'Look for the nature education area', 3),
  ...
  ('33333333-3333-3333-3333-333333333333', 'Clock Room Puzzle', 'What time do all the clocks in the clock room show?', 30, 'text_answer', 'They all show the same time', 3),
  ('33333333-3333-3333-3333-333333333333', 'Final Revelation', 'What is written on the scroll in the secret chamber?', 45, 'text_answer', 'You must solve all other puzzles first', 4)
